...
DEFAULT_MODEL_PATH = "/home/scratch.mkilaru_coreai/GLM-4.7"
DEFAULT_OUTPUT_DIR = "/home/scratch.mkilaru_coreai/GLM-4.7-NVFP4"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Quantize GLM-4.7 to NVFP4 (Blackwell FP4, W4A4) using llm-compressor oneshot. "
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="If set (default), allow custom model code for GLM checkpoints.",
    )
